...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    <meta charset="utf-8" />
    <title>{{ config('app.name', 'KidKinder') }}</title>
  ...
  <body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        ...
        >
          ...
          @else
          <a href="{{ Route::has('register') ? route('register') : route('login') }}" class="btn btn-primary px-4">Join Now!</a>
          @endauth
        </div>
      </nav>
    </div>
      ...
      <div class="container">
        <div class="text-center pb-2">
          <p class="section-title px-5">
            <span class="px-2">Popular Subjects</span>
          </p>
          <h1 class="mb-4">Subjects for Your Kids</h1>
        </div>
        <div class="row">
          <div class="col-lg-4 mb-5">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img class="card-img-top mb-2" src="{{ asset('kidkinder/img/class-1.jpg') }}" alt="" />
          ...
          <div class="col-lg-4 mb-5">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img class="card-img-top mb-2" src="{{ asset('kidkinder/img/class-2.jpg') }}" alt="" />
              <div class="card-body text-center">
          ...
          <div class="col-lg-4 mb-5">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img class="card-img-top mb-2" src="{{ asset('kidkinder/img/class-3.jpg') }}" alt="" />
              <div class="card-body text-center">
        ...
        <div class="row pb-3">
          <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm mb-2">
              <img class="card-img-top mb-2" src="{{ asset('kidkinder/img/blog-1.jpg') }}" alt="" />
          ...
          <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm mb-2">
              <img class="card-img-top mb-2" src="{{ asset('kidkinder/img/blog-2.jpg') }}" alt="" />
              <div class="card-body bg-light text-center p-4">
                <h4 class="">Diam amet eos at no eos</h4>
                <div class="d-flex justify-content-center mb-3">
                  <small class="mr-3"
          ...
          <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm mb-2">
              <img class="card-img-top mb-2" src="{{ asset('kidkinder/img/blog-3.jpg') }}" alt="" />
              <div class="card-body bg-light text-center p-4">
                <h4 class="">Diam amet eos at no eos</h4>
                <div class="d-flex justify-content-center mb-3">
                  <small class="mr-3"
    ...
    >
      <div class="row pt-5">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
          <h3 class="text-primary mb-4">Query</h3>
          <form action="">
            <div class="form-group">
              <input
                type="email"
      ...
      >
        <p class="m-0 text-center text-white">
          &copy;
          <a class="text-primary font-weight-bold" href="#">EduHive</a>.
          All Rights Reserved.
